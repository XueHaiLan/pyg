<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"D:\pyg\public/../application/home\view\cart\index.html";i:1569497913;s:40:"D:\pyg\application\home\view\layout.html";i:1570526978;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			var change_num=function(number,element){
				...
				$.ajax({
					...
					'success':function(res){
						...
						//将新的数量放到当前行的ul的number属性上，用于数量报错后的还原
			...
			$('.check_all').change(function(){
				...
				$.ajax({
					'url':"<?php echo url('home/cart/chagestatus'); ?>",
					'type':'post',
					'data':data,
					'dataType':'json',
					'success':function(res){
