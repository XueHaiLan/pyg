<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\pyg\public/../application/home\view\per_center\seckillsetting-safe.html";i:1570593354;s:40:"D:\pyg\application\home\view\layout.html";i:1570526978;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div id="two" class="tab-pane">
                                ...
                                <form class="sui-form form-horizontal sui-validate" data-toggle='validate' id="bind-form">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="button" id="send" phone="<?php echo $phone; ?>" class="sui-btn btn-info" value="发送"></input>
                                        </div>
                                    </div>
