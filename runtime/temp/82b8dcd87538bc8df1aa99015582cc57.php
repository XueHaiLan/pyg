<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\pyg\pyg\public/../application/home\view\login\index.html";i:1569141651;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<div class="login-box">
		...
		<div class="loginArea">
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="<?php echo url('home/login/dologin'); ?>">
          ...
          自动登录
								...
								<div class="logined">
									<a id="login_bth" class="sui-btn btn-block btn-xlarge btn-danger"  target="_blank">登&nbsp;&nbsp;录</a>
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										...
										<li><a href="/plugins/oauth/index.php"><img src="/static/home/img/ali.png" /></a></li>
