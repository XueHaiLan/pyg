<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"D:\pyg\public/../application/home\view\order\pay.html";i:1569586389;s:40:"D:\pyg\application\home\view\layout.html";i:1570526978;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="checkout-steps">
				...
				<div class="step-cont">
					<ul class="payType">
						...
						<li pay_type="<?php echo $v['pay_code']; ?>" class="<?php if(($k=='alipay')): ?>selected<?php endif; ?>"><img src="<?php echo $v['logo']; ?>"></li>
						<?php endforeach; ?>
					</ul>
		...
		$('.submit').click(function (){
			...
			$('.payType li').each(function (i,v){
				if($(v).attr('class')=='selected'){
					// console.log(v);
					pay_type=$(v).attr('pay_type');
				}
			})
			console.log(pay_type);
			//判断是否选中了充值方式
			if(pay_type==''){
				alert('请选择充值方式');return;
			}
