<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\pyg\public/../application/home\view\per_center\newphone.html";i:1570622149;s:40:"D:\pyg\application\home\view\layout.html";i:1570526978;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="yui3-u-1-6 list">
                ...
                <div class="list-items">
                    ...
                    <dl>
                        ...
                        <dd><a href="<?php echo url('home/PerCenter/safety'); ?>"  class="list-active">安全管理</a></dd>
                    </dl>
                </div>
            </div>
            <!--右侧主内容-->
                ...
                <div class="body userSafe">
                    ...
                    <div class="tab-content ">
                        <div id="one" class="tab-pane active">
                            <form action="<?php echo url('home/PerCenter/modPassword'); ?>" method="post" class="sui-form form-horizontal sui-validate" id="jsForm">
                                ...
                                <div class="step-content">
                                    <div id="step1" class="step-content-body">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls fixed">手机验证（<?php echo $phones; ?>）</div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div ><img onclick="this.src='<?php echo captcha_src(); ?>'+'?'+Math.random()" src="<?php echo captcha_src(); ?>" alt="captcha" /></div>
                                            <div class="controls">
                                                验证码
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="button" phone="<?php echo $phone; ?>" id="send"  class="sui-btn btn-info" value="发送"></input>
                                            </div>
                                        </div>
...
<!--                                                <div class="controls fixed">手机验证（<?php echo $phones; ?>）</div>-->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="button" phone="<?php echo $phone; ?>" id="send2"  class="sui-btn btn-info" value="发送"></input>
                                                </div>
                                            </div>
                                            <div class="control-group next-btn">
...
<script>
    $(function(){
        ...
        $('#newphone').click(function () {
            ...
            // console.log(data);
            $.ajax({
                'url':"<?php echo url('home/PerCenter/phoneverify'); ?>",
                'type':'post',
                'data':data,
                'dataType':'json',
        ...
        $('#newphone2').click(function (){
           ...
           $.ajax({
               'url':"<?php echo url('home/PerCenter/newphone'); ?>",
               'type':'post',
               'data':data,
               'dataType':'json',
               'success':function (res){
                   ...
                   if(res['code']==200){
                       alert(res['msg']);
                       // next();
                       location.href="<?php echo url('home/PerCenter/safety'); ?>";
                   }else{
                       alert(res['msg']);
                   }
               }
        ...
        $('#send').click(function (){
            ...
            $.ajax({
                'url':"<?php echo url('home/PerCenter/sendcode'); ?>",
                'type':'post',
                'data':data,
                'dataType':'json',
                'success':function (res){
